            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 md:inset-auto md:top-1/2 md:left-1/2 md:w-[800px] md:h-[600px] bg-zinc-950 border border-zinc-800 shadow-2xl z-[70] flex flex-col overflow-hidden md:rounded-lg"
