        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Modal */}
                    {/* Centering Container */}
                    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 md:p-0 pointer-events-none">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95, y: 20 }}
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.95, y: 20 }}
                            className="w-full h-full md:w-[800px] md:h-[600px] bg-zinc-950 border border-zinc-800 shadow-2xl flex flex-col overflow-hidden md:rounded-lg pointer-events-auto"
                        >
                            {/* Header */}
